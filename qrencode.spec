...
Source0  : https://fukuchi.org/works/qrencode/qrencode-4.1.1.tar.gz
...
%prep
%setup -q -n qrencode-4.1.1
cd %{_builddir}/qrencode-4.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601325291
...
cp %{_builddir}/qrencode-4.1.1/COPYING %{buildroot}/usr/share/package-licenses/qrencode/9a1929f4700d2407c70b507b3b2aaf6226a9543c
%make_install
